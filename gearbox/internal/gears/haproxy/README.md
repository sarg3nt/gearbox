...
The Dashboard gear provides the main monitoring overview for HAProxy servers.

This is a **core gear** that is always enabled and cannot be disabled.
