...
The Logs plugin provides real-time viewing and searching of HAProxy and system logs.
...
To exclude this plugin from a build, use build tags (future enhancement).
