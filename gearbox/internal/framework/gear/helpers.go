// Package gear provides the plugin system for the HAProxy monitoring application.
...
// NewBaseGear creates a new BaseGear with the given info.
...
func (b *BaseGear) RegisterRoutes(r chi.Router) {
	// No routes by default
}

// SidebarItem returns nil by default (no sidebar entry).
// Override this method to add a sidebar entry for your gear.
func (b *BaseGear) SidebarItem() *SidebarConfig {
	return nil
}

// SettingsPage returns nil by default (no settings page).
// Override this method to provide a settings page for your gear.
func (b *BaseGear) SettingsPage(config map[string]any) templ.Component {
	return nil
}

// Permissions returns an empty slice by default.
// Override this method to define permissions for your gear.
func (b *BaseGear) Permissions() []PermissionDef {
	return nil
}

// Migrations returns an empty slice by default.
// Override this method to define database migrations for your gear.
func (b *BaseGear) Migrations() []Migration {
	return nil
}

// GetDeps returns the plugin's dependencies.
// Use this from your plugin implementation to access framework services.
func (b *BaseGear) GetDeps() Dependencies {
	return b.deps
}

// GetLogger returns the plugin's logger.
func (b *BaseGear) GetLogger() *slog.Logger {
	if b.logger == nil {
		return slog.Default()
	}
	return b.logger
...
func (b *BaseGear) GetConfigInt(key string, defaultValue int) int {
	if b.deps.Config == nil {
		return defaultValue
	}
...
func (b *BaseGear) GetConfigBool(key string, defaultValue bool) bool {
	if b.deps.Config == nil {
		return defaultValue
	}
...
func (b *BaseGear) PublishEvent(eventType string, serverID string, data map[string]any) {
...
//	    user := gear.RequireAuth(h.deps.Auth, w, r)
//	    if user == nil {
...
// Example:
//
//	if !gear.RequirePermission(h.deps.Auth, w, r, "logs", "view") {
...
// Returns nil if the cast fails. Use this when you need access to
// GetGearUserPermissions() or GetFullUser().
