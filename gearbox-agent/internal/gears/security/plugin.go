// Package security provides security monitoring (fail2ban, firewall) as a gear.
package security
...
func (p *Gear) handleFail2BanStats(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleFirewallStats(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleSecuritySummary(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) GetFail2BanCollector() *Fail2BanCollector {
	return p.fail2ban
}

// GetFirewallCollector returns the firewall collector for use by other components.
func (p *Gear) GetFirewallCollector() *FirewallCollector {
	return p.firewall
}
...
func (p *Gear) handleBlock(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleUnblock(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleListBlocked(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleCheckBlocked(w http.ResponseWriter, r *http.Request) {
	// Extract IP from path
	ip := chi.URLParam(r, "ip")
	if ip == "" {
		http.Error(w, "IP address required", http.StatusBadRequest)
...
func (p *Gear) handleConfigRead(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleConfigUpdate(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleListBackups(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleConfigRestore(w http.ResponseWriter, r *http.Request) {
	var req struct {
...
func (p *Gear) validateConfig(content string) (string, error) {
...
func (p *Gear) createBackup(reason string) (string, error) {
	// Ensure backup directory exists
	if err := os.MkdirAll(p.backupDir, 0755); err != nil {
...
func (p *Gear) cleanupOldBackups(keep int) {
	entries, err := os.ReadDir(p.backupDir)
	if err != nil {
		return
	}
...
func (p *Gear) parseNftablesSections(content string) []FirewallConfigSection {
