// Package certs provides certificate monitoring as a gear.
package certs
...
func (p *Gear) publishCertificates(data any) error {
...
func (p *Gear) handleRefresh(w http.ResponseWriter, r *http.Request) {
...
func (p *Gear) handleDownload(w http.ResponseWriter, r *http.Request) {
	domain := chi.URLParam(r, "domain")
	if domain == "" {
		http.Error(w, "Domain name required", http.StatusBadRequest)
		return
