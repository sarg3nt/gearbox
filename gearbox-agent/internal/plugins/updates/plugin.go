// Package updates provides OS update management as a plugin.
package updates
...
// Start is a no-op for this plugin.
...
func (p *Plugin) handleListUpgradable(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleTriggerCheck(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleInstallUpdates(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleRebootRequired(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleScheduleReboot(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleCancelReboot(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleListSnapshots(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleCreateSnapshot(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleRestoreSnapshot(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleDeleteSnapshot(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleSearchPackages(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleInstallPackage(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleRemovePackage(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handlePipxStatus(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handlePipxInstall(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handlePipxUninstall(w http.ResponseWriter, r *http.Request) {
	var req PipxPackageRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		http.Error(w, "Invalid request body: "+err.Error(), http.StatusBadRequest)
		return
...
func (p *Plugin) handlePipxUpgrade(w http.ResponseWriter, r *http.Request) {
	var req PipxPackageRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		http.Error(w, "Invalid request body: "+err.Error(), http.StatusBadRequest)
		return
...
func (p *Plugin) handlePipxUpgradeAll(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleUnattendedConfig(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleConfigureUnattended(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleListOperations(w http.ResponseWriter, r *http.Request) {
	if p.aptRunner == nil {
...
func (p *Plugin) handleGetOperation(w http.ResponseWriter, r *http.Request) {
...
func (p *Plugin) handleCancelOperation(w http.ResponseWriter, r *http.Request) {
	operationID := chi.URLParam(r, "id")
	if operationID == "" {
		http.Error(w, "operation_id is required", http.StatusBadRequest)
		return
...
func (p *Plugin) GetUpdatesCollector() *UpdatesCollector {
	return p.collector
}

// GetAptRunner returns the apt runner for use by other components.
func (p *Plugin) GetAptRunner() *AptRunner {
	return p.aptRunner
}
